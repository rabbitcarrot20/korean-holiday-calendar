...
if TYPE_CHECKING:
    from krholidays.utils import country_holidays  # required by docstring
...
class HolidaySum(HolidayBase):
    """
    In this package, we replaced this class with other functions in utils.py.
